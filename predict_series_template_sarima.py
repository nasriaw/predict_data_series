...
def intro():
    ...
    8. Link template, siapkan data dan upload ke https://predict-analysis-data-series.streamlit.app/ ; source code Dashboard Analisis Prediksi (Template) ini silahkan klik: https://github.com/nasriaw/predict_data_series/edit/main/predict_series_template_sarima.py.
